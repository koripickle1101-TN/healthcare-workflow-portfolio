...
with tab1:
    ...
    df = pd.DataFrame({"Method": ["Real-Time Electronic","Manual Phone Call","Prior Visit Assumed","Portal Self-Report","No Verification"], "Accuracy": [97,78,52,61,18]})
    fig = px.bar(df, x="Method", y="Accuracy", text="Accuracy", color="Accuracy", color_continuous_scale=["#CC0000","#FF8200","#228B22"], title="Eligibility Accuracy Rate by Verification Method")
